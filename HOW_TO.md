...
This means the global half is duplicated 24 times, word for word. That duplication is deliberate.
...
- [ ] **Include the shared "If the call fails or hangs" section** (copy it from any existing skill, substituting the binary name). All 24 skills carry it; new ones should too.

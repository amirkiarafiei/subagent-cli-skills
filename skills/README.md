...
24 CLI agents: Antigravity (`agy`), Claude Code, Cline, Codex, Copilot, Cursor, Deep Agents Code
(`dcode`), Devin, Gemini, Goose, Grok, Hermes, Junie, Kilo Code, Kimi Code, Kiro, Mistral Vibe,
Oh My Pi, OpenClaw, OpenCode, OpenHands, Pi, Qoder, Qwen Code.
